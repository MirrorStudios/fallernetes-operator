...
*/}}
{{- define "operator.resourceName" -}}
{{- $fullname := include "operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
